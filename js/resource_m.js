...
function displayAssignEdit(ev, user, task, project, taskid, userid, complete, sdate, edate, aPercent, t)
{
	...
	document.getElementById("aSDate").value			= sdate;
	document.getElementById("aEDate").value			= edate;
	var start 										= sdate.substr(6)+sdate.substr(3,2)+sdate.substr(0,2);
	var end 										= edate.substr(6)+edate.substr(3,2)+edate.substr(0,2);
	document.getElementById("res_aSDate").value			= start;
	document.getElementById("res_aEDate").value			= end;
...
//	document.getElementById('aECal').style.display	= 'table-cell';
	document.getElementById('aSCal').classList.remove('notActive');
	document.getElementById('aECal').classList.remove('notActive');
...
{
	document.getElementById('aSCal').classList.add('notActive');
	document.getElementById('aECal').classList.add('notActive');
